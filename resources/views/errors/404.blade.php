<x-app-layout>
    <div class="min-h-screen flex flex-col items-center justify-center">
        <div class="text-center">
            ...
            <h2 class="text-2xl font-semibold text-gray-800 mt-4">Страница не найдена</h2>
            <p class="text-gray-600 mt-2">Извините, запрашиваемая страница не существует.</p>
            ...
            <div class="mt-8 space-y-4">
                <div class="flex items-center justify-center text-gray-500">
                    ...
                    <span>Возможно, страница была перемещена или удалена</span>
                </div>
