                    ...
                    <form method="POST" action="{{ route('categories.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <div id="name_ru_container" class="lang-content">
                                <x-text-input id="name_ru" class="block mt-1 w-full" type="text" name="name_ru" :value="old('name_ru')" required autofocus placeholder="Название на русском" />
                                <x-input-error :messages="$errors->get('name_ru')" class="mt-2" />
                            </div>
                            <div id="name_ro_container" class="lang-content hidden">
                                <x-text-input id="name_ro" class="block mt-1 w-full" type="text" name="name_ro" :value="old('name_ro')" required placeholder="Denumire în română" />
                                <x-input-error :messages="$errors->get('name_ro')" class="mt-2" />
                            </div>
                            <div id="name_en_container" class="lang-content hidden">
                                <x-text-input id="name_en" class="block mt-1 w-full" type="text" name="name_en" :value="old('name_en')" required placeholder="English name" />
